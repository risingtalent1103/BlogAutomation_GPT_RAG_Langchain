...
Gold's future prospects, Gold standard vs. fiat currencies, Gold as a store of value, Gold's impact on the global economy etc.
Only give me the specific topic nam e after this prompt and nothing else. The topic is:"""
    )
...
- The output must contain body HTML tag. This is very important.
